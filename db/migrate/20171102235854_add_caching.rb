class AddCaching < ActiveRecord::Migration[5.1]
    def self.up
      ...
      add_column :microposts, :cached_weighted_total, :integer, :default => 0
      add_column :microposts, :cached_weighted_average, :float, :default => 0.0
      ...
      add_index  :microposts, :cached_weighted_total
      add_index  :microposts, :cached_weighted_average
    ...
    def self.down
      ...
      remove_column :microposts, :cached_weighted_total
      remove_column :microposts, :cached_weighted_average
    end
